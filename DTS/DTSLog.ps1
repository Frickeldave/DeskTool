function Write-DTSLog {
    ...
    New-Item -Path "$PSScriptRoot\log" -ItemType Directory -Force | Out-Null
    ...
    if($LogSource -eq "main") {
        ...
        Write-PodeLog -Name "log" -InputObject @{Message=$Message; Component=$Component; Type=$Type; LogFileDir="$PSScriptRoot\log"; LogFileName="DTS.log"; LogTarget="File"}
    }
